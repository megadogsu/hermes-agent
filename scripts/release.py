...
AUTHOR_MAP = {
    "omar@kostudios.io": "OmarB97",  # PR #39345 salvage (preserve final_response on every run_conversation() terminal-failure branch so direct-index callers don't KeyError)
